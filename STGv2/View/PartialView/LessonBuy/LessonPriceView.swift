...
class LessonPriceView : UIButton {
    ...
    required init(lessonLiteViewModel: LessonLiteViewModel, isActive: Bool){
        ...
        nameLabel.text = "Разовый доступ на 1 месяц"
        ...
        priceLabel.text = lessonLiteViewModel.price_str ?? "<ошибка>"
